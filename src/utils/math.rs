//! Mathematical helper functions and sample data generators.
...
/// # Examples
/// ```
/// use automl::utils::math::elementwise_multiply;
/// let a = [1, 2, 3];
/// let b = [4, 5, 6];
/// assert_eq!(elementwise_multiply(&a, &b), vec![4, 10, 18]);
/// ```
#[must_use]
...
/// # Examples
/// ```
/// use automl::utils::math::regression_testing_data;
/// let (_x, _y) = regression_testing_data();
/// ```
///
/// # Panics
///
/// Panics if matrix creation fails.
#[must_use]
